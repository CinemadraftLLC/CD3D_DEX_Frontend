  ...
  return (
    <Stack width={"100%"} direction={"column"}>
      ...
      <div className={styles.bidPriceInput}>
        ...
        />
        <Typography variant="subtitle2" gutterBottom component="div" display={'flex'} justifyContent={'space=between'}>
          BUSD <Image src={BUSD} alt="Picture of BUSD" style={{marginLeft: '10px'}} className={styles.busdImage} />
        </Typography>
      </div>
