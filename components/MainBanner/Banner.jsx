					...
					<div className={styles.bannerInner}>
						<Grid item xs={12} sm={12} md={6}>
							<Typography
								...
								gutterBottom
								component="h3">
								Where <span>DeFi</span> and<span> Gaming</span>{" "}
								meet <i>Play. Trade. Hold. WIN.</i>
							</Typography>
							<Typography
								variant="subtitle1"
								gutterBottom
								component="p">
								The official DeFi launchpad & token of the
								CinemaDraft game
							</Typography>
							<Button
								variant="contained"
							...
							<Link
								...
								<div
									...
									<div
										...
										<Image
											src={
												"/assets/homepage/VisaLogo/visa.png"
											}
											alt={"visa logo"}
											height={"30px"}
											width={"78px"}
									...
									<div
										...
										<Image
											src={
												"/assets/homepage/MasterCardLogo/mastercard.png"
											}
											alt={"mastercard logo"}
											height={"30px"}
											width={"49px"}
									...
									<div
										...
										<Image
											src={
												"/assets/homepage/Applepaylogo/applepay.png"
											}
											alt={"apple pay logo"}
											height={"30px"}
											width={"73px"}
