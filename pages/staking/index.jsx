...
const Staking = () => {
	...
	const handleStStaking = () => {
		setSelectedStStaking(!selectedStStaking);
		setShowStaking(!showStaking);
	};

	const handleLpStaking = () => {
		setSelectedLpStaking(!selectedLpStaking);
	};
							...
							<MiningItemContainer
								...
								<Box
									...
									<Image
										src={
											selectedStStaking
												? "/assets/images/Single Token Staking Icon@2x.png"
												: "/assets/images/st_staking_lg.png"
										}
										alt={""}
										width={25}
										height={25}
								...
								<Stack direction={"column"} spacing={2}>
									<Stack direction={"row"}>
										...
										{selectedStStaking ? (
											<Image
												src={
													"/assets/svgs/Eo_circle_red_white_checkmark.svg"
												}
												alt={""}
												width={20}
												height={20}
									...
									<Typography
										variant={"subtitle2"}
										component={"span"}>
										The amount of token rewards increases
										the longer the single-sided tokens are
										deposited.
									</Typography>
								</Stack>
							</MiningItemContainer>
							...
							<MiningItemContainer
								...
								<Box
									...
									<Image
										src={
											selectedLpStaking
												? "/assets/images/LP Staking Icon@2x.png"
												: "/assets/images/lp_staking_lg.png"
										}
										alt={""}
										width={25}
										height={25}
								...
								<Stack direction={"column"} spacing={2}>
									...
									<Typography
										...
										component={"span"}>
										The amount of token rewards increases
										the longer the LP tokens are deposited.
									</Typography>
								</Stack>
							</MiningItemContainer>
						</Grid>
